class GAN():
  def __init__(self,config = None):
    ...
    self.Ncritic = 10 # Number of Critic Trainings per Generator Training
  ...
  def TrainingStep(self,RealImages):
    ...
    with tf.GradientTape() as GenTape, tf.GradientTape() as DiscTape:
      ...
      DiscLoss = self.WassersteinLoss(tf.ones_like(RealOutput),RealOutput) + self.WassersteinLoss((- tf.ones_like(RealOutput)),FakeOutput)
